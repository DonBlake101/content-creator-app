...
const TikTokFollowers = () => {
  ...
  const fetchTikTokData = async () => {
    ...
    try {
      ...
      setError('Unable to fetch TikTok data. Please try again later.');
  ...
  const handleContinue = () => {
    ...
    if (!isCountryEligible(country, 'tiktok')) {
      setIsCountryError(true);
      setModalMessage('Unfortunately, your country does not allow for monetization on TikTok.');
      setShowModal(true);
      return;
    }
    ...
    if (followerCount < 10000) {
      setModalMessage(`You currently have ${followerCount} followers. TikTok requires a minimum of 10,000 followers for monetization.`);
      setShowModal(true);
      return;
    }

    navigate('/instagram-followers', {
      state: {
        ...location.state,
        tiktok: {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            Enter your TikTok details to check monetization eligibility
          </p>
        </motion.div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="mb-8">
            ...
            <select
              ...
              className="w-full p-4 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
              required
            >
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-4">
              <input
                ...
                className="flex-1 p-4 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                required
              />
              <button
            ...
            <div className="space-y-6 mb-8">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Minimum requirement: 10,000 followers
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Will be fetched from TikTok API when integrated
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Based on $0.02 to $0.04 per 1,000 views
                </p>
              </div>
            </div>
          )}
